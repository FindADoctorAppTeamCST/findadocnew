...
public class DoctorLogin extends AppCompatActivity {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                RequestQueue queue = Volley.newRequestQueue(DoctorLogin.this);
                StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (jsonResp.getString("resp").equals("1")) {
                                ...
                                builder.setPositiveButton("Try Again", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Toast.makeText(context, "Enter Correct Credentials and Log In again", Toast.LENGTH_LONG).show();
                                    }
                                });
                            ...
                            Toast.makeText(DoctorLogin.this, "Error Connecting to Server. Try again.", Toast.LENGTH_LONG).show();
                        }
                    }
